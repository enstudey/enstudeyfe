    ...
    <main className="py-12 w-full space-y-6 flex-grow">
      ...
      <div className="prose max-w-none space-y-6 text-sm text-slate-700 leading-relaxed text-justify">
        ...
        <section className="space-y-2">
          ...
          <p>
            Chúng tôi nghiêm cấm mọi hành vi sử dụng công cụ tự động (bots, crawlers, scrapers) để cào dữ liệu hàng loạt từ website mà không có sự đồng ý bằng văn bản của người đại diện dự án. Hành vi phá hoại, tấn công từ chối dịch vụ (DDoS) hoặc can thiệp vào mã nguồn chạy client-side của hệ thống sẽ bị xử lý theo Luật An ninh mạng Việt Nam.
          </p>
        </section>
