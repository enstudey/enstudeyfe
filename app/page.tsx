      ...
      <div className="lg:col-span-8 xl:col-span-3 space-y-6">
            ...
            <div className="relative z-10 space-y-4 max-w-xl">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm font-medium pt-2">
                <li className="flex items-center gap-2">
                  <span className="text-blue-200">⚡</span> Lưu tiến độ học tập
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-200">🔥</span> Tích luỹ Streak rèn luyện
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-200">🏆</span> Leo top Bảng Xếp Hạng
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-200">💎</span> Tự động lưu Sổ tay câu sai
                </li>
              </ul>
        ...
        <div className="bg-[#0F172A] text-white rounded-xl p-6 md:p-8 shadow-sm space-y-6 relative overflow-hidden border border-slate-800/80">
          ...
          <div className="space-y-3">
            <span className="bg-blue-500/10 text-blue-400 text-[10px] px-2.5 py-1 rounded-full font-extrabold uppercase tracking-wider border border-blue-500/20">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        {u.avatarColor ? (
                          ...
                          <div className="w-7 h-7 rounded-full flex items-center justify-center bg-blue-100 text-blue-700 text-xs font-bold uppercase select-none shrink-0">
                            {u.nickname.charAt(0).toUpperCase()}
                          </div>
                        )}
                        <span className="text-xs text-slate-800 truncate max-w-[110px]">{u.nickname}</span>
                      </div>
                      <span className="text-xs font-bold text-blue-500 shrink-0">{u.currentStreak} 🔥</span>
                    </div>
                  );
                })}
                  ...
                  <>
                    ...
                    {leaderboardData.currentUserRank.surroundingUsers.map((u) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 ${isCurrent ? "bg-blue-500 text-white" : "bg-slate-100 text-slate-650"
                              }`}>
                              {u.rank}
                            </span>
                            {u.avatarColor ? (
