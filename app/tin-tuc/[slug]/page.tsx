  ...
  if (!post) {
    return (
      <main className="max-w-3xl mx-auto py-12 w-full flex-grow space-y-6 text-center">
        ...
        <Link href="/tin-tuc" className="text-sm text-blue-600 hover:underline font-semibold">
  ...
  return (
    <>
      ...
      <main className="py-12 flex-grow w-full space-y-6">
        <div>
          <Link href="/tin-tuc" className="text-sm text-blue-600 hover:underline inline-flex items-center gap-1 font-semibold">
            &larr; Quay lại danh sách tin tức
          </Link>
        </div>
          ...
          <article className="lg:col-span-7 prose max-w-none leading-relaxed text-slate-700">
            ...
            <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left not-prose">
              ...
              <Link
                ...
                className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl transition duration-200 whitespace-nowrap"
              >
                Làm Test liền &rarr;
              </Link>
            </div>
