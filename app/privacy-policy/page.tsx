    ...
    <main className="w-full py-12 flex-grow space-y-6">
      <div className="max-w-[1200px] mx-auto bg-white border border-border/50 rounded-3xl p-6 md:p-10 shadow-sm space-y-6 text-justify">
        ...
        <div className="prose max-w-none space-y-6 text-sm text-slate-700 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2 mt-2">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  Người dùng có thể chủ động tắt tính năng quảng cáo cá nhân hóa bằng cách truy cập vào trang <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">Cài đặt quảng cáo của Google</a>.
                </li>
              </ul>
            </div>
          ...
          <p className="font-bold text-indigo-600 mt-6 text-center">
