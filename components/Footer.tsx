...
export default function Footer() {
  return (
    <footer className="bg-[#16213A] text-[#94A0B8] border-t border-[#243356] mt-20 min-h-[250px] hidden md:block">
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 items-start justify-between">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-[#94A0B8] leading-relaxed max-w-xs">
              Nền tảng luyện TOEIC chuẩn ETS được cá nhân hóa bằng AI.
            </p>
            <div className="space-y-1.5 text-xs text-[#94A0B8]/80">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2.5 text-xs text-[#94A0B8]">
          ...
          <div className="space-y-3 md:text-right">
            ...
            <div className="flex flex-col md:items-end gap-2.5 text-xs text-[#94A0B8]">
        ...
        <div className="mt-12 pt-6 border-t border-[#243356] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[10px] text-[#94A0B8]/80 font-semibold tracking-wider">
            © 2026 EnStudey. All rights reserved.
          </p>

          {/* Badge Version trực quan SaaS với EnStudey Hex Tokens */}
          <div className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#1E294B] border border-[#243356] text-[9px] font-bold text-[#94A0B8]">
