  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-3xl p-8 text-center max-w-xl mx-auto shadow-sm space-y-6">
        <div className="w-20 h-20 mx-auto rounded-full bg-indigo-50 dark:bg-indigo-950/30 flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-extrabold text-2xl shadow-inner animate-bounce font-mono">
          {score}%
        </div>
