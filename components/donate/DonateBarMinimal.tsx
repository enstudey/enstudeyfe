...
export default function DonateBarMinimal() {
  ...
  return (
    <>
      <div
        className="w-full bg-sky-50/40 border border-sky-500/10 rounded-2xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 transition duration-300"
