...
export default function DonateBarMinimal() {
  ...
  return (
    <>
      <div
        className="w-full bg-violet-50/40 border border-violet-500/10 rounded-2xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 transition duration-300"
