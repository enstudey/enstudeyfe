...
export default function CookieBanner() {
  ...
  return (
    <div
      className={`fixed bottom-6 right-6 z-50 p-5 rounded-2xl border border-card-border bg-card/95 backdrop-blur-md shadow-2xl max-w-sm w-[calc(100%-3rem)] transition-all duration-500 ease-in-out transform ${isVisible
    ...
    >
      <div className="relative flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-sky-100 text-sky-600 text-sm">
            🍪
          </div>
        ...
        <p className="text-sm leading-relaxed text-foreground/90 pr-1">
          ...
          <Link
            href="/privacy-policy"
            className="underline text-sky-600 hover:opacity-80 font-medium transition-opacity"
        ...
        <div className="flex justify-end mt-1">
          <button
            ...
            className="px-5 py-2 bg-sky-600 text-white rounded-xl text-sm font-medium transition hover:opacity-90 active:scale-95 cursor-pointer shadow-sm"
