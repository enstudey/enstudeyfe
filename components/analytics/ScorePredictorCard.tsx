    ...
    <div className="relative overflow-hidden rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/20 via-slate-900/40 to-purple-950/30 p-6 sm:p-8 shadow-xl backdrop-blur-md">
      ...
      <div className="relative z-10 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="rounded-full bg-indigo-600/10 px-3 py-1 text-xs font-semibold text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-300 border border-indigo-500/20">
            Kỳ thi {examType}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
          {/* Predicted Score */}
          <div className="rounded-2xl border border-indigo-500/20 bg-white/60 dark:bg-slate-900/60 p-4 backdrop-blur-sm shadow-sm">
