...
export const ScorePredictorCard: React.FC<ScorePredictorCardProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-sky-500/20 bg-gradient-to-br from-sky-950/20 via-slate-900/40 to-purple-950/30 p-6 sm:p-8 shadow-xl backdrop-blur-md">
      ...
      <div className="relative z-10 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="rounded-full bg-sky-600/10 px-3 py-1 text-xs font-semibold text-sky-600 dark:bg-sky-500/20 dark:text-sky-300 border border-sky-500/20">
            Kỳ thi {examType}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
          {/* Predicted Score */}
          <div className="rounded-2xl border border-sky-500/20 bg-white/60 dark:bg-slate-900/60 p-4 backdrop-blur-sm shadow-sm">
            <span className="text-xs font-medium text-slate-500 dark:text-slate-400">
              Điểm Dự Báo Hiện Tại
            </span>
            <div className="mt-1 text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-sky-600 to-purple-600 bg-clip-text text-transparent">
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-800 p-0.5">
            <div
              className="h-full rounded-full bg-gradient-to-r from-sky-500 via-purple-500 to-indigo-500 transition-all duration-1000 ease-out shadow-sm"
